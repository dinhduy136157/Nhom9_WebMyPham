<%@ Page Title="" Language="C#" MasterPageFile="~/View/User/AnotherLayout.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Website_MyPham.View.User.HienThiTheoGia.Index" %>
        ...
        <div class="main__tabnine">
            <div class="grid wide">
                ...
                <div style="margin-bottom: 20px" class="main__sort">
                    <h3 style="font-size: 16px" class="sort__title">
                        Hiển thị kết quả theo
                    </h3>
                    <asp:DropDownList style="font-size: 16px" ID="sortSelect" runat="server" CssClass="sort__select" onchange="redirectToPage(this)">
