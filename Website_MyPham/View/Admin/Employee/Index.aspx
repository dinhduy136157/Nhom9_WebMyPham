    ...
    <Columns>
       ...
       <%-- <asp:BoundField DataField="avatar" HeaderText="Ảnh" />--%>
         <asp:TemplateField HeaderText="Image">
             <ItemTemplate>
                  <asp:Image ID="anh" runat="server" Width="150" ImageUrl='<%#"~/Image/"+Eval("avatar") %>' />
                

            </ItemTemplate>
            <%--  <ItemTemplate>
                <asp:Image ID="imgAvatar" runat="server" Width="100px" Height="100px"
                    ImageUrl='<%# Eval("avatar", "~/Image/{0}") %>' />
            </ItemTemplate>--%>
         </asp:TemplateField>
        ...
        <button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp"
            ...
            <ItemTemplate>
                <asp:Button ID="xoa" CommandName="xoa" CommandArgument='<%# Bind("employee_id") %>'
               ...
               OnClientClick="return confirm('Bạn có chắc xoá không ?')" />
                ...
                <asp:TemplateField HeaderText="Sửa">
                 <ItemTemplate>
                     <asp:Button ID="capnhat" CommandName="sua" CommandArgument='<%# Bind("employee_id") %>'
